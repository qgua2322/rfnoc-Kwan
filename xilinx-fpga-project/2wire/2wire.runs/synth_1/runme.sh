...
HD_PWD='/home/vivado/rfnoc/src/rfnoc-kwan_cross/xilinx-fpga-project/2wire/2wire.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log x300.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source x300.tcl
